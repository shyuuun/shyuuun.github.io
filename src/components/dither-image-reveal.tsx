...
function imageURL(value: unknown): string {
  ...
  return (value as { src: string; url: string; alt: string }).url;
}
...
export function DitherReveal(props: DitherRevealProps) {
  ...
  useEffect(() => {
    ...
    function render() {
      ...
      const c1 = hexToRgb(props.color1 ?? DEFAULTS.color1);
      const c2 = hexToRgb(props.color2 ?? DEFAULTS.color2);
  ...
  }, [imgUrl, props.color1, props.color2]);
...
void main() {
    ...
    vec3 ditherColor = mix(uColor1, uColor2, tone);
